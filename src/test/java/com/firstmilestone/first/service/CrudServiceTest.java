...
class CrudServiceTest {
    ...
    void getSpecificUser() {
        ...
        User user = new User(1,"Vivek0099", "Vivek", "Patel", "vivek.patel@paytm.com","8484339901","Pune", "Gwalior");
    ...
    @Test
    void addNewUser() {
        User user = new User("Vivek0099", "Vivek", "Patel", "vivek.patel@paytm.com","8484339901","Pune", "Gwalior");

        User user1 = new User(1,"Vivek0099", "Vivek", "Patel", "vivek.patel@paytm.com","8484339901","Pune", "Gwalior");
